...
const ResumeSlider = () => {
  ...
  const visibleTemplates = typeof window !== 'undefined' 
    ? (window.innerWidth < 640 ? 2 : window.innerWidth < 768 ? 3 : window.innerWidth < 1024 ? 4 : 6)
    : 6;
    ...
    <div className="relative mx-auto max-w-sm min-w-sm sm:max-w-sm md:max-w-md lg:max-w-xl">
      ...
      <div className="overflow-hidden">
        <div
          ...
          style={{
            transform: `translateX(-${currentIndex * (100 / visibleTemplates)}%)`,
          }}
        >
          {templates
...
const JobDescriptionUploader = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error("An error occurred while submitting the job description.");
    }
  };
