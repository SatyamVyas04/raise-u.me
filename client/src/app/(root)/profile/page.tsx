...
import { FileText, Briefcase, GraduationCap, Award, Link as LinkIcon } from 'lucide-react';
    ...
    return (
        <div className="container mx-auto p-4 space-y-6">
            <Card>
                <CardHeader className="flex flex-row items-center space-x-4 pb-2">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">{userData.occupation}</p>
                    </div>
                </CardHeader>
                <CardContent>
            ...
            <Tabs defaultValue="education" className="w-full">
                ...
                <TabsContent value="responsibility">
                    <Card>
                        <CardHeader>
                            <CardTitle className="flex items-center">
                                <Award className="mr-2" /> Positions of Responsibility
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
                            <ScrollArea className="h-[200px]">
                                <ul className="list-disc list-inside space-y-2">
                                    {userData.positionsOfResponsibility.map((position, index) => (
            ...
            <Card>
                ...
                <CardContent>
                    <Sheet open={isResumePreviewOpen} onOpenChange={setIsResumePreviewOpen}>
                        ...
                        <SheetContent side="right" className="w-[400px] sm:w-[540px]">
                            <SheetHeader>
                                ...
                                <SheetDescription>Your uploaded resume</SheetDescription>
                            </SheetHeader>
